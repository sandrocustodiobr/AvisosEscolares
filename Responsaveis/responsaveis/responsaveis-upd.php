...
<form method="POST" action="responsaveis-upd-ok.php">
    <div id="formulario">
        <input name="id" type="number" value="<?php echo $item->id; ?>" readonly hidden/><br>
        ...
        <input class="form-inline" name="admin" type="radio" value="0" <?php if (!$item->admin) { echo "checked"; } ?>/> Não<br><br>
