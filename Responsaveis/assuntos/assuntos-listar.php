...
foreach ($listar as $dados){
    ...
    <td><a href="assuntos-unico.php?id='.$dados->id.'" class="btn btn-primary">Ver</a>
...
<div class="content table-responsive table-full-width">
    <table class="table table-hover table-striped">
        <tr><th>ID</th><th>Nome Curto</th><th>Descrição</th><th>Ano/Sem.</th><th>Curso</th><th>Ver/Editar</th><th>Excluir</th></tr>
        <?php echo $saida; ?>
    </table>
</div>
